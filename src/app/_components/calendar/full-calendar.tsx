...
const CalendarWeekView = () => {
  const { view, date, locale, events, setDate, setView } = useCalendar()
          ...
          return (
            <div
              onClick={() => {
                ...
                setDate(_date)
                setView('day')
                // here I want to set the state to set the current date to the clicked date and go to the day view
              }}
              className={cn(
                'overflow-auto p-2 text-sm text-muted-foreground ring-1 ring-border hover:cursor-pointer hover:bg-accent',
...
const CalendarYearView = () => {
  const { view, date, today, locale, setDate, setView } = useCalendar()
              ...
              return (
                ...
                >
                  <div
                    ...
                    className={cn(
                      'grid aspect-square size-full place-content-center tabular-nums hover:cursor-pointer hover:rounded-full hover:bg-accent hover:bg-purple-500',
